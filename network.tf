...
#Accept VPC peering request in eu-west-1 from eu-west-2
...
resource "aws_route_table" "internet_route" {
  ...
  route {
    cidr_block = "192.168.1.0/24"
    gateway_id = aws_vpc_peering_connection.euwest2-euwest1.id
  }
...
#Overwrite deafult route table of VPC(Master) with our route table entries
...
#Overwrite deafult route table of VPC(Worker) with our route table entries
